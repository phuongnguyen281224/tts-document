...
POLL_INTERVAL = 3
MAX_WAIT = 600 # Increased for larger PDF

def main():
    print("--- [Verification] Project Verification with User PDF ---")
    
    # 1. Path to user PDF
    pdf_path = r"e:\Document\New folder\tts-document\file_input\MLOps và MLflow_ Dễ hiểu.pdf"
            ...
            if status_resp.status_code == 200:
                ...
                if state == "SUCCESS":
                    ...
                    if download_resp.status_code == 200:
                        local_mp3 = f"verification_result_{task_id}.mp3"
